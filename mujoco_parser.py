...
class MuJoCoParserClass(object):
    ...
    def get_quat_body(self,body_name):
        """
            Get body quaternion
        """
    ...
    def solve_ik(self,body_name,p_trgt,R_trgt,IK_P,IK_R,q_init,rev_joint_idxs, idxs_jacobian,
    ...
    def get_pcd_from_depth_img(self,depth_img,fovy=45):
        ...
        img_xyz = meters2xyz(depth_img,cam_matrix) # [H x W x 3]
        xyz_transpose = np.transpose(img_xyz,(2,0,1)).reshape(3,-1) # [3 x N]
    ...
    def get_egocentric_rgb_depth_pcd(self,p_ego=None,p_trgt=None,rsz_rate=50,fovy=45,
        ...
        # Get PCD
        pcd = self.get_pcd_from_depth_img(depth_img_rsz,fovy=fovy) # [N x 3]
